#ifndef ADVANCED_DISSOLVE_VARIABLES_INCLUDED
#define ADVANCED_DISSOLVE_VARIABLES_INCLUDED


#define DECLARE_TEXTURE_2D_GLOBAL(t) TEXTURE2D(t); SAMPLER(sampler##t); uniform TEXTURE2D(t##_Global); SAMPLER(sampler##t##_Global);
...
float _DissolveCombineWithMasterNodeColor;    uniform float _DissolveCombineWithMasterNodeColor_Global;
	...
	DECLARE_TEXTURE_2D_GLOBAL(_DissolveEdgeTexture)
	...
	DECLARE_TEXTURE_2D_GLOBAL(_DissolveMap1)		
	...
	DECLARE_TEXTURE_2D_GLOBAL(_DissolveMap2)        
	...
	DECLARE_TEXTURE_2D_GLOBAL(_DissolveMap3)   
...
float _DissolveMaskReInverted;
#define VALUE_AXIS_REINVERT _DissolveMaskReInverted
