...
Shader "URPTimeDefenders/UnitGeomtry"
{
    Properties
    {
...
/// 4행 0,0,0,0 
        ...
        [Space(10)]
        _MaskTexture("Mask R(specular)G()B()A()", 2D) = "black"{}        
...
#include "../Includes/CustomLight.hlsl"
            ...
            float4 frag(v2f i) : SV_Target {
                ...
                if(_UseLightMapper == 1){
                    mainTexColor = CustomLightShadedColor(i.position_WS, i.normal_WS, i.view_WS, mainTexColor, float4(_IndirectColor.rgb, _IndirectMulti),
_DirectionLightV0, _DirectionLightV1, _DirectionLightV2, _DirectionLightV3, 
_PointLight0_V0, _PointLight0_V1, _PointLight0_V2, _PointLight0_V3, _PointLight1_V0, _PointLight1_V1, _PointLight1_V2, _PointLight1_V3, 
_PointLight2_V0, _PointLight2_V1, _PointLight2_V2, _PointLight2_V3, _PointLight3_V0, _PointLight3_V1, _PointLight3_V2, _PointLight3_V3, 
_CelMidPoint, _CelSoftness, _ShadowBrightness, _ShadePivot, _RelativeScale );
                }
                ...
                if(_NeedRimLight > 0){
                    ...
                    float fresnel = pow(1 - saturate(dot(i.view_WS, i.normal_WS)), 3);
